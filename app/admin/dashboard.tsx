...
const ClassPerformanceCard = ({ grade, students, attendance, trend }: PerformanceCardProps) => {
  ...
  return (
    <View style={styles.performanceCard}>
      <View style={[styles.trendIconBox, { backgroundColor: iconBg }]}>
...
const NavItem = ({ icon, label, isActive = false }: NavItemProps) => (
  <TouchableOpacity style={styles.navItem}>
    <Ionicons name={icon} size={22} color={isActive ? "#4461F2" : "#9CA3AF"} />
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.gridContainer}>
            <SummaryCard icon="people" label="Total Students" value="1,250" color="#4461F2" />
            <SummaryCard icon="id-card" label="Total Teachers" value="84" color="#4461F2" />
            <SummaryCard icon="library" label="Classrooms" value="42" color="#4461F2" />
            <SummaryCard icon="checkmark-circle" label="Exams Done" value="12" color="#4461F2" />
        </View>
        ...
        <View style={styles.section}>
            ...
            <View style={styles.chartCard}>
                <View style={styles.chartContainer}>
                    ...
                    <Bar height={70} label="APR" />
                    <Bar height={85} label="MAY" />
                    <Bar height={65} label="JUN" />
                </View>
            </View>
        </View>
      ...
      {/* Bottom Navigation (Admin 5-Tab Layout) */}
